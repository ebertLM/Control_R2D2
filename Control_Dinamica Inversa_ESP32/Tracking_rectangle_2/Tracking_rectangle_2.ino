...
BLA::Matrix<3,1> p1 = {0.216f,  0.100f, 0.225f};  // Vértice 1
BLA::Matrix<3,1> p2 = {0.216f,  0.100f, 0.375f}; // Vértice 2
BLA::Matrix<3,1> p3 = {0.216f, -0.100f, 0.375f}; // Vértice 3
BLA::Matrix<3,1> p4 = {0.216f, -0.100f, 0.225f}; // Vértice 4
