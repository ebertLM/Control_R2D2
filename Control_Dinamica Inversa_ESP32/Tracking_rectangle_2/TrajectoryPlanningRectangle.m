classdef TrajectoryPlanningRectangle < handle
    ...
    methods
        function this = TrajectoryPlanningRectangle(robotCinematicObj, p1_, p2_, p3_, p4_, so, Ts,...
        ...
        function [PD, dPD, ddPD, QD, dQD, ddQD] = PosVelAcc(this)
            ...
            for k = 1:nPoints
                ...
                % perfil trapezoidal
                [s,ds,dds]    = this.profile(t,currentSide);

                % Posicion, velocidad y aceleracion en XYZ
                [pd,dpd,ddpd] = this.trajectory(s,ds,dds,currentSide); 
