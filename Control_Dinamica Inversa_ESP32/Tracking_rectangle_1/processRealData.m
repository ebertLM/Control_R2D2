...
rectanglePlanner = TrajectoryPlanningRectangle(cin, p1, p2, p3, p4, so, Ts,...
                                               tadd, factor, ds_max, dds_max);

% 5. Posición, velocidad y aceleración deseada 
%    en el espacio de trabajo y articular
[PD, dPD, ddPD, QD, dQD, ddQD] = rectanglePlanner.PosVelAcc();
